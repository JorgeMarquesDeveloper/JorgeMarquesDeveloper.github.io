...
function buscarOpcoes($conn, $tabela, $campo)
{
...
// Busca opções para os campos guarnicao e especialidade
$guarnicaoOpcoes = buscarOpcoes($conn, 'guarnicao_ott', 'guarnicao');
$especialidadeOpcoes = buscarOpcoes($conn, 'especialidade_ott', 'especialidade');
;
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Oficial Técnico
                                                Temporário - Inscrição em Especialidade
                                            </div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-12 col-md-6 mb-4">
                            <div class="card border-left-warning shadow h-100 py-2" style="color: #094c00;">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                1º Passo - Escolha do guarnição e especialidade
                                            </div>
                                    ...
                                    <form  method="post" action="system_ott_esp_cad-insert.php"  enctype="multipart/form-data">
                                        <!-- Guarnição e Especialidade -->
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="guarnicao">Guarnição</label>
                                                <select class="form-control" id="guarnicao" name="guarnicao" required>
                                                    <?php foreach ($guarnicaoOpcoes as $opcao): ?>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-control" id="especialidade" name="especialidade"
                                                    required>
                                                    <?php foreach ($especialidadeOpcoes as $opcao): ?>
                                                        <option value="<?php echo $opcao; ?>">
                                                            <?php echo $opcao; ?>
                                                        </option>
                                                    <?php endforeach; ?>
                                        ...
                                        <!-- Área de Upload de Documentos Obrigatórios -->
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-12 col-md-6 mb-4">
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                2º Passo - Uploads de documentos obrigatórios
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label for="carteiraConselho">Carteira do Conselho</label>
                                        <input type="file" class="form-control" id="carteira_conselho"
                                            name="carteira_conselho" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="certidoesNegativas">Certidões Negativas</label>
                                        <input type="file" class="form-control" id="certidoes_negativas"
                                            name="certidoes_negativas" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="posGraduacoes">Pós-Graduações (se aplicável)</label>
                                        <input type="file" class="form-control" id="posGraduacoes" name="pos_graduacoes">
                                    </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>SSMR/7ªRM &copy; SisCTemp</span>
                    </div>
                </div>
            </footer>
        </div>

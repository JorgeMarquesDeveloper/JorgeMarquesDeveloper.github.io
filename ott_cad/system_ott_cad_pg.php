                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                                5º Passo - Títulos/Graus/Diplomas (posterior ao curso de formação)
                                            </div>
                                        </div>
                                    </div>
                                    <form enctype="multipart/form-data" onsubmit="submitForm(event)">
                                        <div class="mb-3">
                                            <label for="tipoPosGraduacao" class="form-label">Tipo de
                                                Pós-Graduação:</label>
                                            <select class="form-control" id="tipoPosGraduacao" name="tipoPosGraduacao">
                                        ...
                                        <div class="mb-3">
                                            <label for="nomePosGraduacao" class="form-label">Nome da
                                                Pós-Graduação:</label>
                                            <input type="text" class="form-control" id="nomePosGraduacao"
                                        ...
                                        <div class="mb-3">
                                            <label for="diploma" class="form-label">Diploma (Anexo):</label>
                                            <input type="file" class="form-control" id="diploma" name="diploma">
                                        </div>
                                        <button type="submit"
                                            class="btn btn-block btn-outline-success">Cadastrar</button>
                                    </form>
                                </div>
                            </div>
                        </div>

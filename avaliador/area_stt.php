...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <div class="container px-4">
        <a class="navbar-brand" href="#page-top">Sargento Técnico Temporário</a>
...
<header class="bg-custom-color bg-success text-white">
    <div class="container px-4 text-left">
        <h1 class="fw-bolder">Anotações referentes ao cargo de Sargento Técnico Temporário</h1>
        <p class="lead">Insira uma nova anotação!</p>
        <form action="adicionar_nota.php" method="post" class="mt-3">
    <div class="form-group">
        <label for="titulo">Título:</label>
        <input type="text" class="form-control" id="titulo" name="titulo" required>
        <input type="hidden" name="area" value="STT">
    </div>
    <div class="form-group">
